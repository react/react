  ...
  ((module.exports = function ($$$config) {
    ...
    function beginWork(current, workInProgress, renderLanes) {
      ...
      if (null !== current)
        ...
        didReceiveUpdate = !1;
        if ((family = isHydrating))
          warnIfNotHydrating(),
            (family = 0 !== (workInProgress.flags & 1048576));
        family &&
          ((family = workInProgress.index),
          warnIfNotHydrating(),
          pushTreeId(workInProgress, treeForkCount, family));
      }
      workInProgress.lanes = 0;
      switch (workInProgress.tag) {
        case 16:
          ...
          a: {
            ...
            if (supportsHydration && prevSibling.isDehydrated)
              if (
                ...
                family = createCapturedValueAtFiber(
                  Error(
                    "This root received an early update, before anything was able hydrate. Switched the entire root to client rendering."
                  ),
                  workInProgress
                );
                queueHydrationError(family);
                workInProgress = mountHostRootWithoutHydrating(
                  current,
                  workInProgress,
                  nextProps,
          ...
          if (supportsSingletons)
            return (
              ...
              null === current &&
                ...
                didSuspendOrErrorDEV ||
                  ((family = diffHydratedPropsForDevWarnings(
                    prevSibling,
                    workInProgress.type,
                    workInProgress.pendingProps,
                    family
        ...
        case 5:
          return (
            null === current &&
              ...
              (family = validateHydratableInstance(
                workInProgress.type,
                workInProgress.pendingProps,
                nextProps
              )),
              ...
              (nextState = !prevSibling) ||
                ...
                (nextState = !nextProps)),
              nextState &&
                (family && warnNonHydratedInstance(workInProgress, prevSibling),
                throwOnHydrationMismatch(workInProgress))),
            pushHostContext(workInProgress),
        ...
        case 6:
          return (
            null === current &&
              ...
              (family = !renderLanes) ||
                ((family = canHydrateTextInstance(
                  renderLanes,
                  workInProgress.pendingProps,
                  rootOrSingletonContext
                )),
                null !== family
                  ? ((workInProgress.stateNode = family),
                    (hydrationParentFiber = workInProgress),
                    (nextHydratableInstance = null),
                    (family = !0))
                  : (family = !1),
        ...
        case 30:
          if (enableViewTransition)
            return (
              ...
              (family = workInProgress.pendingProps),
              null != family.name && "auto" !== family.name
                ? (workInProgress.flags |=
    ...
    exports.injectIntoDevTools = function () {
      var internals = {
        ...
        reconcilerVersion: "19.3.0-www-classic-eb343c7c-20260707"
      };
