...
describe('Store inconsistency - focused Activity slice', () => {
  let React;
  let Activity;
  let actAsync;
  let store;
  ...
  // @reactVersion >= 19.0
  it('does not diverge when an Activity slice is focused as its boundary suspends', async () => {
    const App = buildApp();
  ...
  // @reactVersion >= 19.0
  it('is clean when the slice is focused before the boundary suspends', async () => {
    const App = buildApp();
  ...
  // @reactVersion >= 19.0
  it('is clean under the default component filters', async () => {
    const App = buildApp();
