...
export function requestUpdateLane(fiber: Fiber): Lane {
  ...
  if (transition !== null) {
    ...
    if (__DEV__) {
      ...
      if (hasPotentialUseWarnings()) {
        // This is an update, not the loading sequence resolving. The render it
        // causes isn't a retry of the one that suspended, so don't warn unless
        // that happens again.
        clearUseWarnings();
      }
    }
