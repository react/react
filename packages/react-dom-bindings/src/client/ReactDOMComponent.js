...
let didWarnForNewStringPropsWithObjectValue: {[string]: boolean};
if (__DEV__) {
  didWarnForNewBooleanPropsWithEmptyValue = {};
  didWarnForNewStringPropsWithObjectValue = {};
}
...
function setProp(
  ...
  switch (key) {
    ...
    case 'popoverTarget':
      if (__DEV__) {
        if (
          !didWarnForNewStringPropsWithObjectValue[key] &&
          value != null &&
          typeof value === 'object'
        ) {
          didWarnForNewStringPropsWithObjectValue[key] = true;
          console.error(
